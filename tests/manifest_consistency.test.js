...
assert.match(contentSource, /visualProtocolVersion/);
assert.match(contentSource, /vision unavailable/);
...
assert.match(backgroundSource, /const REQUIRED_SERVER_PROTOCOL_VERSION = 3/);
