...
(async () => {
  ...
  assert.equal(elements.get("health").textContent, "Server v0.6.0, protocol 11, helper 4, skill 2, Skills v2/3, apps Terminal/Ghostty, vision ok, pid 123");
  assert.equal(context.formatServerHealth({
    ...
    pid: 123
  }), "Server v0.6.0, protocol 11, helper 4, skill 2, pid 123");
