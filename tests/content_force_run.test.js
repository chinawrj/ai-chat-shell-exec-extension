...
assert.match(source, /function isPanelForceRunExecutionActive\(\) \{\s*return Boolean\(activeCallId\) \|\| skillHelperInFlight \|\| skillRecoveryInFlight \|\|\s*forceRunInFlight \|\| panelShellHelperActive;\s*\}/);
